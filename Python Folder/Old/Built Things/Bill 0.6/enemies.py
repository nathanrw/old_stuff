...
class RaRaRasputin(BaseEnemy):
    ...
    def shoot(self):
        t_x = random.randrange(0,100,5)
        t_y = random.randrange(320,150,20)
        t = (t_x, t_y)
        o = self.rect.center
        dist_x = t[0] - o[0]
        dist_y = t[1] - o[1]
        self.angle = math.atan(dist_y/dist_x)
        self.shooting = 1
