...
class BillScythe(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.anims = []
        self.anims.append(ImportImg("billscythe.png", -1))
...
def main():
    ...
    Black = []
    Black.append(ImportPNG("black.png"))
    Black.append(ImportPNG("black.png"))
    Black.append(ImportPNG("black.png"))
    ...
    Black.append(ImportPNG("black_1.png"))
    Black.append(ImportPNG("black_1.png"))
    Black.append(ImportPNG("black_2.png"))
    ...
    while 1:
        ...
        if billdead == 0:
            ...
            for sprite in flan_sprites:
                if sprite.rect.center[0] < (bill.rect.right+200) and sprite.rect.center[0] > (bill.rect.left-30):
                    if billscythe.state == "swiping":
                        if sprite.state != "dead" and sprite.state != "rasputin_idle":
                            FlexiGib(sprite.rect.center,Black,12)
                            sprite.destroy()
                            killcounter += 1
