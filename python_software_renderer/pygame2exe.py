...
script = "3D The Second.py"	    	#name of starting .PY
...
extra_data = ['dot.bmp','heightmap.bmp','hills.bmp','hillslarge.bmp','output.bmp','tower.bmp','towersmall.bmp'] #extra files/dirs copied to game
extra_modules = ['pygame.locals','math','ent_ship','entities','filler','functions','get_input','heightmap','input','lighting',
                 'load_models','loadres','lookup','md_ship','md_shiplol','prepare_polygons','projection','resources','rotations',
                 'vector_maths', 'Numeric']   #extra python modules not auto found
